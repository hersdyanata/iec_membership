                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/facebook.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/youtube.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/spotify.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/twitter.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/bing.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/amazon.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/brands/dribbble.svg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('assets/global') }}/images/placeholders/placeholder.jpg" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <div class="media flex-column flex-sm-row mt-0 mb-3">
                                <div class="mr-sm-3 mb-2 mb-sm-0">
                                    <div class="card-img-actions">
                                        <a href="#">
                                            <img src="{{ asset('assets/global') }}/images/placeholders/placeholder.jpg" class="img-fluid img-preview rounded" alt="">
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3 position-relative">
                                    <img src="{{ asset('assets/global') }}/images/placeholders/placeholder.jpg" class="rounded-circle" width="36" height="36" alt="">
