            ...
            <div class="col-lg-6">
                <fieldset>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Label</label>
                                <input type="text" class="form-control" name="prc_label" id="prc_label">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="supplier_select" name="prc_supplier_id" class="form-control select-search" data-fouc>
                            <option value="">-- Pilih Supplier --</option>
                            @foreach ($supplier as $s)
                                <option value="{{ $s->supplier_id }}_{{ $s->supplier_komoditas }}">{{ $s->supplier_nama.' - '.$s->supplier_alamat }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <script>
                        $('#supplier_select').on('change', function(){                                
                            if ($(this).val() != ''){
                                var sellected_supplier = $(this).val().split('_');
                    ...
                    <div class="form-group">
                        ...
                        <select name="prc_komoditas_id" id="prc_komoditas_id" class="form-control select">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <select name="prc_buyer_id" id="prc_buyer_id" class="form-control select" data-fouc>
                            ...
                            @foreach ($buyer as $b)
                                <option value="{{ $b->buyer_id }}">{{ $b->buyer_pic.' - '.$b->buyer_perusahaan }}</option>
                            @endforeach
                        </select>
                    </div> --}}
                            ...
                            <div class="form-group">
                                ...
                                <select name="prc_container_size" id="prc_container_size" class="form-control select" data-fouc>
                                    ...
                                    @foreach ($containers as $c)
                                        <option value="{{ $c['container_size'] }}">{{ $c['container_name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="prc_container_qty" id="prc_container_qty">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="prc_total_qty" id="prc_total_qty" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="prc_margin_persentase" id="prc_margin_persentase">
                        ...
                        <script>
                            if ($('#prc_margin_persentase') != ''){
                                $('#prc_margin_persentase').on('keyup', function(){                                
                                    ...
                                    $('#prc_margin_idr').val(margin_idr.toLocaleString());
                                });
                            }
                        </script>
