                ...
                <div class="card-body">
                    ...
                    <fieldset class="mb-3">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="group_nama" id="group_nama">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="group_deskripsi" id="group_deskripsi">
                            </div>
                        </div>
                                    ...
                                    @foreach ($list_menu as $i => $d)
                                        <optgroup label="{{ $d['div_nama'] }}">
                                            @foreach ($d['menus'] as $m)
                                                <option value="{{ $m['menu_id'] }}">{{ $m['menu_nama_ina'] }}</option>
                                            @endforeach
                                        </optgroup>
                                    @endforeach
                                </select>
